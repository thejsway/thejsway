...
Function naming is just as important as variable naming. You should choose names that clearly express the function's purpose and follow a naming convention. Refer to the [appendix](#style-guide) for some useful advice.
